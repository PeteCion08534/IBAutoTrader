...
import com.theta.enums.types.IntegerValuedEnumReflect;

//Please notice the calls to getNameFromValue *************************
public class IntegerValuedEnumType <T extends Enum<T> & IntegerValuedEnum> 
    ...
    public void setParameterValues(Properties parameters) {
        ...
        try {
            enumClass = (Class<T>) Class.forName(enumClassName).asSubclass(Enum.class).
                    asSubclass(IntegerValuedEnum.class); //Validates the class but does not eliminate the cast
    ...
    throws HibernateException, SQLException {
        if (value==null) {
            ...
            st.setInt( index, ((T) value).getValue() );
        }
    }
    ...
    public String objectToSQLString(Object value) {
        return '\'' + ((T) value).getValue().toString() + '\'';
    }
    ...
    public Object fromXMLString(String xmlValue) {
        String name = IntegerValuedEnumReflect.getNameFromValue(enumClass, Integer.valueOf(xmlValue));
