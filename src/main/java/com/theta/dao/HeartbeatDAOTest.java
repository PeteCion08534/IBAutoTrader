...
public class HeartbeatDAOTest {
	 ...
	 *
	 */
	private HeartbeatDAO dataStore;

	/**
	 * Instantiates a new HeartbeatDAOTest.
	 *
	 */
	public HeartbeatDAOTest() {
	}

	/**
	 * Method to test Heartbeat domain object.
	 *
	 */
	@Rollback(false)
	@Test
	 ...
	 */
	@Autowired
	public void setDataStore(HeartbeatDAO dataStore) {
