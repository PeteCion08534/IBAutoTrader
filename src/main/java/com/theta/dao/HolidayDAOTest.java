...
public class HolidayDAOTest {
	 ...
	 *
	 */
	private HolidayDAO dataStore;

	/**
	 * Instantiates a new HolidayDAOTest.
	 *
	 */
	public HolidayDAOTest() {
	}

	/**
	 * Method to test Holiday domain object.
	 *
	 */
	@Rollback(false)
	@Test
	 ...
	 */
	@Autowired
	public void setDataStore(HolidayDAO dataStore) {
