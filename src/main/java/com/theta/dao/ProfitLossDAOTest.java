...
public class ProfitLossDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private ProfitLossDAO dataStore;

	/**
	 * Instantiates a new ProfitLossDAOTest.
	 *
	 */
	public ProfitLossDAOTest() {
	}

	/**
	 * Method to test ProfitLoss domain object.
	 *
	 */
	@Rollback(false)
	@Test
	 ...
	 */
	@Autowired
	public void setDataStore(ProfitLossDAO dataStore) {
