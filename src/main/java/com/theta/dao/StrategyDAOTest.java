...
public class StrategyDAOTest {
	 ...
	 *
	 */
	private StrategyDAO dataStore;

	/**
	 * Instantiates a new StrategyDAOTest.
	 *
	 */
	public StrategyDAOTest() {
	}

	/**
	 * Method to test Strategy domain object.
	 *
	 */
	@Rollback(false)
	@Test
	 ...
	 */
	@Autowired
	public void setDataStore(StrategyDAO dataStore) {
