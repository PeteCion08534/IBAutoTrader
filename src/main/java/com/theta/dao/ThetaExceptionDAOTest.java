...
public class ThetaExceptionDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private ThetaExceptionDAO dataStore;

	/**
	 * Instantiates a new ThetaExceptionDAOTest.
	 *
	 */
	public ThetaExceptionDAOTest() {
	}

	/**
	 * Method to test ThetaException domain object.
	 *
	 */
	@Rollback(false)
	@Test
	public void ThetaException() {
		ThetaException instance = new ThetaException();
	 ...
	 */
	@Autowired
	public void setDataStore(ThetaExceptionDAO dataStore) {
