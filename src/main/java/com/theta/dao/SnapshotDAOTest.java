...
public class SnapshotDAOTest {
	 ...
	 *
	 */
	private SnapshotDAO dataStore;

	/**
	 * Instantiates a new SnapshotDAOTest.
	 *
	 */
	public SnapshotDAOTest() {
	}

	/**
	 * Method to test Snapshot domain object.
	 *
	 */
	@Rollback(false)
	@Test
	 ...
	 */
	@Autowired
	public void setDataStore(SnapshotDAO dataStore) {
