...
public class SnapshotOptionDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private SnapshotOptionDAO dataStore;

	/**
	 * Instantiates a new SnapshotOptionDAOTest.
	 *
	 */
	public SnapshotOptionDAOTest() {
	}

	/**
	 * Method to test SnapshotOption domain object.
	 *
	 */
	@Rollback(false)
	@Test
	public void SnapshotOption() {
		SnapshotOption instance = new SnapshotOption();
	 ...
	 */
	@Autowired
	public void setDataStore(SnapshotOptionDAO dataStore) {
