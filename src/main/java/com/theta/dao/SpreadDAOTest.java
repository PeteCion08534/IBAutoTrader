...
public class SpreadDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private SpreadDAO dataStore;
	private StrategyDAO strategyDataStore;

	/**
	 * Instantiates a new SpreadDAOTest.
	 *
	 */
	public SpreadDAOTest() {
	}

	
	/**
	 * Method to get a Spread domain object
	 */
	@Rollback(false)
	@Test
	public void getFromSpread() {
	
		dataStore.findSpreadByPositionId(2);
	}
		
	/**
	 * Method to test Spread domain object.
	 *
	 */
	@Rollback(false)
	@Test
	public void Spread() {
		Spread instance = new Spread();


//		instance.init(strategy);
	 ...
	 */
	@Autowired
	public void setDataStore(SpreadDAO dataStore) {
		this.dataStore = dataStore;
	}
	
	@Autowired
	public void setStrategy(StrategyDAO stategyDataStore) {
		this.strategyDataStore = strategyDataStore;
	}
}
