...
public class StrategyAccountDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private StrategyAccountDAO dataStore;

	/**
	 * Instantiates a new StrategyAccountDAOTest.
	 *
	 */
	public StrategyAccountDAOTest() {
	}

	/**
	 * Method to test StrategyAccount domain object.
	 *
	 */
	@Rollback(false)
	@Test
	public void StrategyAccount() {
		StrategyAccount instance = new StrategyAccount();
	 ...
	 */
	@Autowired
	public void setDataStore(StrategyAccountDAO dataStore) {
