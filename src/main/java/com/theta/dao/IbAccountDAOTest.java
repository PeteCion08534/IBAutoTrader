...
public class IbAccountDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private IbAccountDAO dataStore;

	/**
	 * Instantiates a new IbAccountDAOTest.
	 *
	 */
	public IbAccountDAOTest() {
	}

	/**
	 * Method to test IbAccount domain object.
	 *
	 */
	@Rollback(false)
	@Test
	public void IbAccount() {
		IbAccount instance = new IbAccount();
	 ...
	 */
	@Autowired
	public void setDataStore(IbAccountDAO dataStore) {
