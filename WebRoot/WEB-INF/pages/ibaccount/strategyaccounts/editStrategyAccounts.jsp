...
<html>
<head>
<title>Edit <fmt:message key="ibaccount.title"/> <fmt:message key="strategyaccount.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveIbAccountStrategyAccounts" method="POST" modelAttribute="strategyaccount">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="ibaccount_ibAccountId" value="${ibaccount_ibAccountId}" >
