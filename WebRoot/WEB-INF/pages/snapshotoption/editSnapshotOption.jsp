...
<html>
<head>
<title>Edit <fmt:message key="snapshotoption.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveSnapshotOption" method="POST" modelAttribute="snapshotoption">
