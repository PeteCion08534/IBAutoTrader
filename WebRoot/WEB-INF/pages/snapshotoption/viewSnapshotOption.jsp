...
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			...
			<h1><fmt:message key="snapshot.title"/></h1>
					
						<c:if test='${snapshotoption.snapshot != null}'>
			<table cellpadding="0" cellspacing="0" id="viewTable">
				<tbody>
					<tr>
						<td  class="label">
						...
						<td>
							${snapshotoption.snapshot.snapshotId}
						&nbsp;
						</td>
					</tr>
					<tr>
						...
						<td>
							<fmt:formatDate dateStyle="short" type="date" value="${snapshotoption.snapshot.snapshotDate.time}"/>
						&nbsp;
						</td>
					</tr>
					<tr>
						...
						<td>
							${snapshotoption.snapshot.symbol}
						&nbsp;
						</td>
					</tr>
					<tr>
						...
						<td>
							${snapshotoption.snapshot.symbolPrice}
						&nbsp;
						</td>
					</tr>
					<tr>
						...
						<td>
							${snapshotoption.snapshot.expiryYear}
						&nbsp;
						</td>
					</tr>
					<tr>
						...
						<td>
							${snapshotoption.snapshot.expiryMonth}
						&nbsp;
						</td>
					</tr>
					<tr>
						...
						<td>
							${snapshotoption.snapshot.expirtyDay}
						&nbsp;
						</td>
					</tr>
					<tr>
						...
						<td>
							${snapshotoption.snapshot.createdBy}
						&nbsp;
						</td>
					</tr>
					<tr>
						...
						<td>
							<fmt:formatDate dateStyle="short" type="date" value="${snapshotoption.snapshot.createdDate.time}"/>
						&nbsp;
						</td>
					</tr>
					<tr>
						...
						<td>
							${snapshotoption.snapshot.updatedBy}
						&nbsp;
						</td>
					</tr>
					<tr>
						...
						<td>
							<fmt:formatDate dateStyle="short" type="date" value="${snapshotoption.snapshot.updatedDate.time}"/>
						&nbsp;
						</td>
					</tr>
				</tbody>
			</table>
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/editSnapshotOptionSnapshot?snapshotoption_snapshotOptionId=${snapshotoption.snapshotOptionId}&snapshot_snapshotId=${snapshotoption.snapshot.snapshotId}&"><span><img src="images/icons/edit.gif" /><fmt:message key="navigation.edit"/></span></a></div>
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/confirmDeleteSnapshotOptionSnapshot?snapshotoption_snapshotOptionId=${snapshotoption.snapshotOptionId}&snapshot_snapshotId=${snapshotoption.snapshot.snapshotId}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
						</c:if>
						<c:if test='${snapshotoption.snapshot == null}'>
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/newSnapshotOptionSnapshot?snapshotoption_snapshotOptionId=${snapshotoption.snapshotOptionId}&"><span><img src="images/icons/new.gif" /><fmt:message key="navigation.new"/> <fmt:message key="snapshot.title"/></span></a></div>
						</c:if>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
