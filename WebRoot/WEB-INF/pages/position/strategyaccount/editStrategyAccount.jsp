...
<html>
<head>
<title>Edit <fmt:message key="position.title"/> <fmt:message key="strategyaccount.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/savePositionStrategyAccount" method="POST" modelAttribute="strategyaccount">
