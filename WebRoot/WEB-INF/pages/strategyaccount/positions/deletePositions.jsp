...
<html>
<head>
<title>View <fmt:message key="strategyaccount.title"/> <fmt:message key="position.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			<h1><fmt:message key="navigation.view"/> <fmt:message key="position.title"/></h1>
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteStrategyAccountPositions?strategyaccount_strategyAccountId=${strategyaccount_strategyAccountId}&position_positionId=${position.positionId}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
