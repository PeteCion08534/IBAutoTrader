...
<html>
<head>
<title>Edit <fmt:message key="strategyaccount.title"/> <fmt:message key="position.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveStrategyAccountPositions" method="POST" modelAttribute="position">
