...
<html>
<head>
<title>View <fmt:message key="snapshot.title"/> <fmt:message key="snapshotoption.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			<h1><fmt:message key="navigation.view"/> <fmt:message key="snapshotoption.title"/></h1>
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteSnapshotSnapshotOptions?snapshot_snapshotId=${snapshot_snapshotId}&snapshotoption_snapshotOptionId=${snapshotoption.snapshotOptionId}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
