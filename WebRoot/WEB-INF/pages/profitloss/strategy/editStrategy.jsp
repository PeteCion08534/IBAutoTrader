...
<html>
<head>
<title>Edit <fmt:message key="profitloss.title"/> <fmt:message key="strategy.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProfitLossStrategy" method="POST" modelAttribute="strategy">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="profitloss_profitLossId" value="${profitloss_profitLossId}" >
