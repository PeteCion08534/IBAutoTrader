...
<html>
<head>
<title>Edit <fmt:message key="profitloss.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProfitLoss" method="POST" modelAttribute="profitloss">
