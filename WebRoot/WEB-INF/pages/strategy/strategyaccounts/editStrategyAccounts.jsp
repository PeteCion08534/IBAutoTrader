...
<html>
<head>
<title>Edit <fmt:message key="strategy.title"/> <fmt:message key="strategyaccount.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveStrategyStrategyAccounts" method="POST" modelAttribute="strategyaccount">
